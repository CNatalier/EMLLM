...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path',
                        default='data/images/',
                        help='Path to the images dataset for finetuning')
    ...
    model_stack = build_model(text_model_id=args.text_model_id,
                              ...
                              freeze_vision_model=True,#defaulted True
                              freeze_language_model=False,#defaulted False
    ...
    if list(pathlib.Path(args.checkpoint_save_path).glob("checkpoint-*")):
